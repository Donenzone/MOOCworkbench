...
urlpatterns = [
    ...
    url(r'^step/files$', ExperimentsManager.views.FileListForStep.as_view(), name="file_list_for_step"),
    ...
    url(r'^file/(?P<experiment_id>\d+)/$', login_required(ExperimentsManager.views.FileViewGitRepository.as_view()), name='file_detail'),
