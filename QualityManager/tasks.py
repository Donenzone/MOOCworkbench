...
from QualityManager.measurements.requirements_measurement import RequirementsMeasurement
from QualityManager.measurements.vcs_measurement import VersionControlUseMeasurement
