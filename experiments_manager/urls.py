...
urlpatterns = [
    ...
    url(r'^new$', login_required(experiments_manager.views.views_create.StepOneExperimentCreateView.as_view()), name="experiment_new"),
    url(r'^new/status$', experiments_manager.views.views_create.step_two_experiment_status_create, name="experiment_status_create"),
    url(r'^steps/(?P<experiment_id>\d+)$', experiments_manager.views.views_create.StepThreeChooseExperimentSteps.as_view(),
    ...
    url(r'^file/(?P<experiment_id>\d+)/$', login_required(experiments_manager.views.views.FileViewGitRepository.as_view()),
        name='file_detail'),
    url(r'^readme/(?P<experiment_id>\d+)/$', experiments_manager.views.views.readme_of_experiment, name='experiment_readme'),
    ...
    url(r'^single-issues/(?P<experiment_id>\d+)/(?P<issue_nr>\d+)$', experiments_manager.views.views.experiment_single_issue,
