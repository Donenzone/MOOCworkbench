    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requirements', models.ManyToManyField(to='requirements_manager.Requirement')),
                ('travis', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='build_manager.TravisInstance')),
            ],
            options={
                'abstract': False,
            },
