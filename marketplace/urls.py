...
urlpatterns = [
    ...
    url(r'^view/(?P<pk>\d+)/$', login_required(InternalPackageDetailView.as_view()), name="package_detail"),
    ...
    url(r'^edit/(?P<pk>\d+)/$', login_required(InternalPackageDetailView.as_view()), name="internalpackage_edit"),
]
