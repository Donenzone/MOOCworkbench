...
/***/ function(module, exports, __webpack_require__) {
	...
	var Csrf = __webpack_require__(168);
	...
	var RegistrationComponent = React.createClass({
	  ...
	  handlePasswordCopyChange: function handlePasswordCopyChange(e) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('i', { className: 'glyphicon password-glypicon' })
	      ),
	      React.createElement('input', { type: 'submit', value: 'Register', className: 'btn btn-success' })
	    );
	  }
	});
